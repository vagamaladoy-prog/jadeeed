...
Заказы и статусы · товары (uz/ru, цвета, фото с перетаскиванием, остатки по размерам XS–XXXL, состав, плотность, флаги) · акции (% или сумма, на товары или категорию, даты) · баннеры (ПК 2400×1800, 4:3, и телефон 1080×1350, alt-текст uz/ru, ссылка, превью) · фразы бренда и где они показываются · категории · размерные сетки · контакты и соцсети · тексты «О бренде» и «Доставка» · тестовое сообщение в Telegram.

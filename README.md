...
Заказы и статусы · товары (uz/ru, цвета, фото с перетаскиванием, остатки по размерам XS–XXXL, состав, плотность, флаги) · акции (% или сумма, на товары или категорию, даты) · баннеры на весь экран (ПК — горизонтальная от 2400×1350, телефон — вертикальная от 1080×1920, alt-текст uz/ru, ссылка, превью) · фразы бренда и где они показываются · категории · размерные сетки · контакты и соцсети · тексты «О бренде» и «Доставка» · тестовое сообщение в Telegram.
